# """
# Django settings for ansd_suivi project.
...
# SECRET_KEY = 'django-insecure-z3)&fie)*!1xyb8lgxd3j^_sdu%c8^am%ih#-krik907-yp)a3'
...
#     "http://localhost:3000", # Adresse de votre frontend React en développement
#     "http://127.0.0.1:3000",
# ]

# WSGI_APPLICATION = 'ansd_suivi.wsgi.application'
...
MIDDLEWARE = [
    ...
    'django.middleware.common.CommonMiddleware',
    'django.middleware.security.SecurityMiddleware',
    'whitenoise.middleware.WhiteNoiseMiddleware',  # gestion fichiers statiques en prod
    'django.contrib.sessions.middleware.SessionMiddleware',
    'django.middleware.common.CommonMiddleware',
    'django.middleware.csrf.CsrfViewMiddleware',
    'django.contrib.auth.middleware.AuthenticationMiddleware',
